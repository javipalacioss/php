...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['guardar'])) {
        ...
        if (isset($_POST['categoria'], $_POST['titulo'], $_POST['descripcion'], $_POST['pasos'])) {
            ...
            actualizarReceta($_SESSION['editar'],$_POST['categoria'], $_POST['titulo'], $_POST['descripcion'], $_POST['pasos'], $_SESSION['ingreReceta']);
...
$_SESSION['receta'] = obtenerDetalle($_SESSION['editar']);
$stmtIngredientes = obtenerIngredientesPorReceta($_SESSION['editar']);
...
<body>
    ...
    <form action="" method="POST">
        ...
        <input type="text" name="titulo" value="<?php echo $_SESSION['receta']['titulo']?>"><br>
        <label for="descripcion">Descripción:</label>
        <input type="text" name="descripcion" value="<?php echo $_SESSION['receta']['descripcion']?>"><br>
        <label for="pasos">Pasos:</label>
        <input type="text" name="pasos" value="<?php echo $_SESSION['receta']['pasos']?>"><br>
    </form>
